 ...
 */
//@Service
@ConditionalOnProperty(prefix = com.cxh.cxhossspringbootstarter.properties.FileServerProperties.PREFIX, name = "type", havingValue = FileServerProperties.TYPE_S3)
