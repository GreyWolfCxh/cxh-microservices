package com.cxh.cxhuaa.service.impl;
...
import com.cxh.cxhredisspringbootstarter.template.RedisRepository;
import com.cxh.cxhuaa.exception.ValidateCodeException;
import com.cxh.cxhuaa.service.IValidateCodeService;
...
public class ValidateCodeServiceImpl implements IValidateCodeService {
  ...
  /*  @Resource
    ...
    public void saveImageCode(String deviceId, String imageCode) {
        System.out.println(buildKey(deviceId));
